...
// app/styles/app.css
var app_default = "/build/_assets/app-TVKWXWBN.css";
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1746564533564.7678";
}
function Navbar() {
  _s();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("nav", { className: "relative bg-white shadow", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex h-16 justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-shrink-0 items-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/", className: "flex items-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: "/images/logo.png", alt: "Mu\xF1e Chic Logo", className: "h-12 w-auto" }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "hidden md:ml-6 md:flex md:items-center md:space-x-4", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "-mr-2 flex items-center md:hidden", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { type: "button", className: "relative inline-flex items-center justify-center rounded-md p-2 text-gray-700 hover:bg-gray-100 hover:text-black focus:outline-none focus:ring-2 focus:ring-inset focus:ring-black", onClick: () => setIsOpen(!isOpen), children: [
        ...
        isOpen ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(HiX, { className: "block h-6 w-6", "aria-hidden": "true" }, void 0, false, {
          fileName: "app/components/Navbar.tsx",
          lineNumber: 54,
          columnNumber: 25
        }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(HiMenu, { className: "block h-6 w-6", "aria-hidden": "true" }, void 0, false, {
          fileName: "app/components/Navbar.tsx",
          lineNumber: 54,
          columnNumber: 80
        }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: `${isOpen ? "block" : "hidden"} md:hidden`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "space-y-1 px-2 pb-3 pt-2", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "px-2 pt-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("a", { href: "https://wa.me/tunumero", target: "_blank", rel: "noopener noreferrer", className: "block w-full text-center btn-primary", onClick: () => setIsOpen(false), children: "Contactar" }, void 0, false, {
        fileName: "app/components/Navbar.tsx",
        lineNumber: 76,
        columnNumber: 13
      }, this) }, void 0, false, {
...
function MobileNavLink({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to, className: "block rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-100 hover:text-black", onClick, children }, void 0, false, {
    fileName: "app/components/Navbar.tsx",
    lineNumber: 100,
    columnNumber: 10
  }, this);
...
//# sourceMappingURL=/build/root-6PG5MF3B.js.map
